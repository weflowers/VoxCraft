...
void GameMenu::MainMenu()
{
	...
	{
		ImGui::Text("VoxCraft (Author: Milo Banks)");
...
void GameMenu::CreateWorldDialog()
{
	...
	{
		ImGui::InputText("World Name", input_buf_, WORLD_NAME_LENGTH);
		ImGui::InputText("World Seed", seed_buf_, WORLD_NAME_LENGTH);
		if(*input_buf_ && ImGui::Button("Create World!", s_buttonSize))
		{
